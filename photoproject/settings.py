...
SECRET_KEY = 'django-insecure-9ot-5!pmqj%fj0gz&5va#!ir@$x1bclwn0wg_rv&qf!!p$%#*m'
...
#メールサーバーへの接続設定
DEFAULT_FROM_EMAIL="yoshiyuzu33111@gmail.com"
EMAIL_HOST="smtp.gmail.com" #GmailのSMTPサーバー
EMAIL_PORT=587 #Gmailのポート番号
EMAIL_HOST_USER="yoshiyuzu33111@gmail.com" #Gmailのアドレス
EMAIL_HOST_PASSWORD="isyxfgatibzhwdno"
EMAIL_USE_TLS=True #SMTPサーバーと通信する際にTLS接続を使う
